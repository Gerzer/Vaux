...
extension HTML {
	...
	public func alignment(_ value: Alignment) -> HTML {
		return self.attr("align", value.rawValue)
	}
	...
	public func attr(_ key: String, _ value: String? = nil) -> HTML {
		return AttributedNode(attribute: Attribute(key: key, value: value), child: self)
	}
	...
	public func backgroundColor(_ hexCode: String) -> HTML {
		return self.attr("bgcolor", hexCode)
	}
	...
	public func color(_ hexCode: String) -> HTML {
		return self.attr("color", hexCode)
	}
	...
	public func columnSpan(_ value: Int) -> HTML {
		return self.attr("colspan", String(value))
	}
	...
	public func rowSpan(_ value: Int) -> HTML {
		return self.attr("rowspan", String(value))
	}
	...
	public func scope(_ value: Scope) -> HTML {
		return self.attr("scope", value.rawValue)
	}
	...
	public func style(_ attributes: [StyleAttribute]) -> HTML {
		...
		return self.attr("style", inlineStyle)
	}
	...
	public func type(_ mime: String) -> HTML {
		return self.attr("type", mime)
	}
	
	public func type(_ mime: MIME) -> HTML {
		return self.attr("type", mime.rawValue)
	}
...
extension SVG {
	...
	public func attr(_ key: String, _ value: String? = nil) -> SVG {
		return AttributedSVGNode(attribute: Attribute(key: key, value: value), child: self)
	}
